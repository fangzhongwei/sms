package com.montnets.mwgate.httppost;
...
public class SmsUtil {
     ...
     */
    public String[] MongateGetDeliverForPost(Object params,  boolean bKeepAlive, Object connection){
        String[] Result = null;
     ...
     * 返回值：正数或0：帐户可发送条数
     ...
     其他错误见附录
     */
    public Integer MongateQueryBalanceForPost(Object params,  boolean bKeepAlive, Object connection) {
        Integer result =null;
     ...
     * 返回值：错误描述对应说明
     ...
     -999	web服务器内部错误
     */
    public String MongateSendSubmitForPost(Object params, boolean bKeepAlive, Object connection) {
        String result =null;
        try {
            String Message=null;
            if(!bKeepAlive){
     ...
     * 注意：由于单个短信结构体中各元素间，以及短信包中各个短信结构体间采用的分隔符分隔，所以要求短信结构体中各元素的值中不能包含分隔符（,和/），否则将导致解析错误。
     ...
     -999	web服务器内部错误
     */
    public String MongateMULTIXSendForPost(Object params, boolean bKeepAlive, Object connection)
    {
        String result =null;
        try {
            String Message=null;
