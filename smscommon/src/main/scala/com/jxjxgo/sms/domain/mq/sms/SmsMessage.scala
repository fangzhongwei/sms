...
final case class SmsMessage(
  ...
  def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.jxjxgo.sms.domain.mq.sms.SmsMessage = {
    ...
    com.jxjxgo.sms.domain.mq.sms.SmsMessage(
      traceId = __traceId,
      ip = __ip,
  ...
  def companion = com.jxjxgo.sms.domain.mq.sms.SmsMessage
}

object SmsMessage extends com.trueaccord.scalapb.GeneratedMessageCompanion[com.jxjxgo.sms.domain.mq.sms.SmsMessage] {
  implicit def messageCompanion: com.trueaccord.scalapb.GeneratedMessageCompanion[com.jxjxgo.sms.domain.mq.sms.SmsMessage] = this

  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): com.jxjxgo.sms.domain.mq.sms.SmsMessage = {
  ...
  lazy val defaultInstance = com.jxjxgo.sms.domain.mq.sms.SmsMessage(
  )

  implicit class SmsMessageLens[UpperPB](_l: _root_.com.trueaccord.lenses.Lens[UpperPB, com.jxjxgo.sms.domain.mq.sms.SmsMessage]) extends _root_.com.trueaccord.lenses.ObjectLens[UpperPB, com.jxjxgo.sms.domain.mq.sms.SmsMessage](_l) {
